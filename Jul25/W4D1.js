...
function canStringBecomePalindrome(str) {
  ...
  for (let i = 0; i < str.length; i++){
    if (new_dict1.hasOwnProperty(str.substring(i,i+1))){
        new_dict1[str.substring(i,i+1)]++;
    } else{
        new_dict1[str.substring(i,i+1)] = 1;
    }
}

    //console.log("new_dict1 -->",new_dict1);
    let hasOne = false;
    let hasOddPairs = false;
    let hasEvenPairs = false;
    for (key in new_dict1){
        if (new_dict1[key] === 1){
            hasOne = true;
        }
        else if(new_dict1[key]%2 !== 0){
            hasOddPairs = true;
        }
        else if(new_dict1[key]%2 === 0){
            hasEvenPairs = true;
    ...
    if(hasOne && str.length==1) rtBool = true;
    else if(hasEvenPairs){
        rtBool = true;
    }
  return rtBool;
}
console.log("Expected: ",expected1);
console.log("Acutal:   ",canStringBecomePalindrome(str1));
console.log("");
console.log("Expected: ",expected2);
console.log("Acutal:   ",canStringBecomePalindrome(str2));
console.log("");
console.log("Expected: ",expected3);
console.log("Acutal:   ",canStringBecomePalindrome(str3));
console.log("");
console.log("Expected: ",expected4);
console.log("Acutal:   ",canStringBecomePalindrome(str4));
console.log("");
console.log("Expected: ",expected5);
console.log("Acutal:   ",canStringBecomePalindrome(str5));
console.log("");
console.log("Expected: ",expected6);
console.log("Acutal:   ",canStringBecomePalindrome(str6));

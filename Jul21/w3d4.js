...
const students = [
  ...
  console.log("Results:  ", santasNaughtyListFunctional(students,badHabit1));
  ...
  function santasNaughtyListFunctional(persons, badHabit) {
    ...
    returnArr = persons.filter(person => person.habits.includes(badHabit)).map(person => person.firstName+" "+person.lastName);
